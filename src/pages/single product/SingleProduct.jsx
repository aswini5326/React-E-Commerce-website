  ...
  return (
    <div className='singleProduct-container'>
      ...
      <div className="singleProduct-wrapper">
        ...
        <div className="singleProduct-ingoSection">
          ...
          <p className="singleProduct-description">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Porro omnis expedita saepe consequuntur nam beatae!
          </p>
            ...
            <div className="colors-section">
              ...
              <div className="colors">
                {colors.map((color) => (
                  ...
                  style={{backgroundColor: color , outline:selectedColor === color ? `3px solid ${color}` : " " }} onClick={( ) => handleCircleClick(color)} > 
                  </div>
                ))}
              </div>
            </div>
